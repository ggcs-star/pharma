...
use App\Http\Controllers\Api\Users\AuthController as ApiAuthController;
...
use App\Http\Controllers\Master\HomeSectionController;
...
Route::get('/item/suppliers', [
    PurchaseOrderController::class,
    'getItemSuppliers'
]);

Route::get('/purchase/search-item', [
...
Route::post('/customers/ajax-store', [
...
Route::get('/purchase-return/items/{id}', [
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::prefix('purchase-return')->name('purchase-return.')->group(function () {
        ...
        Route::get('/get-purchase-item/{id}', [
            PurchaseReturnController::class,
            'getPurchaseItem'
        ]);
...
Route::get('/item/suppliers', [
    \App\Http\Controllers\Purchase\PurchaseOrderController::class,
    'getItemSuppliers'
]);

Route::post('/purchase-orders/{id}/status', [
    PurchaseOrderController::class,
    'updateStatus'
]);
...
Route::get('/purchase/{purchase}/return', [
    PurchaseReturnController::class,
    'create'
]);
...
Route::get('/api/get-item-full/{id}', function ($id) {
    ...
    return response()->json([
        ...
        'mrp'               => $batch->mrp,
        'offline_price'     => $batch->offline_price,
        'online_price'      => $batch->online_price,
...
Route::prefix('admin')->middleware(['auth'])->group(function () {
    ...
    Route::get('/prescriptions', [
        \App\Http\Controllers\Admin\PrescriptionController::class,
        'index'
    ])->name('admin.prescriptions');

    Route::post('/prescriptions/{id}/update', [
        \App\Http\Controllers\Admin\PrescriptionController::class,
        'update'
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::post('/ajax/manufacturer/store', [
        ManufacturerController::class,
        'storeAjax'
    ])->name('ajax.manufacturer.store');

    Route::post('/ajax/category/store', [
        CategoryController::class,
        'storeAjax'
    ])->name('ajax.category.store');

    Route::post('/ajax/subcategory/store', [
    ...
    */
    ...
    Route::get('/stock/{item}', [
        StockController::class,
        'show'
    ])->name('stock.show');

    Route::get('/stock/batch-ledger/{id}', [
        StockController::class,
        'batchLedger'
...
Route::middleware('auth:supplier')->prefix('supplier')->group(function () {
    ...
    */
    ...
    Route::get('catalogs', [
        SupplierItemCatalogController::class,
        'index'
    ])->name('supplier.catalogs.index');

    Route::get('catalogs/create', [
        SupplierItemCatalogController::class,
        'create'
    ])->name('supplier.catalogs.create');

    Route::post('catalogs', [
        SupplierItemCatalogController::class,
        'store'
    ])->name('supplier.catalogs.store');

    Route::get('catalogs/{id}/edit', [
        SupplierItemCatalogController::class,
        'edit'
    ])->name('supplier.catalogs.edit');

    Route::put('catalogs/{id}', [
        SupplierItemCatalogController::class,
        'update'
    ])->name('supplier.catalogs.update');

    Route::delete('catalogs/{id}', [
        SupplierItemCatalogController::class,
        'destroy'
    ])->name('supplier.catalogs.destroy');

    Route::get('supplier/catalogs/{id}/view', [
        SupplierItemCatalogController::class,
        'show'
    ])->name('supplier.catalogs.show');
    ...
    */
    ...
    Route::get('stocks', [
        SupplierStockController::class,
        'index'
    ])->name('supplier.stocks.index');

    Route::get('stocks/create', [
        SupplierStockController::class,
        'create'
    ])->name('supplier.stocks.create');

    Route::post('stocks', [
        SupplierStockController::class,
        'store'
    ])->name('supplier.stocks.store');

    Route::delete('stocks/{id}', [
        SupplierStockController::class,
        'destroy'
    ])->name('supplier.stocks.destroy');
    ...
    */
    ...
    Route::get('/items', [
        SupplierItemController::class,
        'index'
    ])->name('supplier.items.index');

    Route::get('/items/{id}', [
        SupplierItemController::class,
        'show'
    ])->name('supplier.items.show');
});

/*
|--------------------------------------------------------------------------
| Dashboard Shortcut Routes
|--------------------------------------------------------------------------
*/
