    ...
    <div class="form-container">
        <form method="POST" action="{{ route('supplier.catalogs.update', $catalog->id) }}" id="catalogForm">
                    ...
                    <div class="form-group full-width">
                        ...
                        <select name="item_id" class="form-control-custom @error('item_id') is-invalid @enderror" required>
                            ...
                            @foreach($items as $item)
                                <option value="{{ $item->id }}" {{ old('item_id', $catalog->item_id) == $item->id ? 'selected' : '' }}>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="batch_no" value="{{ old('batch_no', $catalog->batch_no) }}"
                            placeholder="e.g., BATCH-2024-001"
                            class="form-control-custom @error('batch_no') is-invalid @enderror" required>
                        @error('batch_no')
                            <div class="invalid-feedback-custom">
                                <i class="fa fa-exclamation-circle"></i> {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="expiry_date"
                            value="{{ old('expiry_date', \Carbon\Carbon::parse($catalog->expiry_date)->format('Y-m-d')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="qty" value="{{ old('qty', $catalog->current_stock ?? 0) }}"
                            class="form-control-custom @error('qty') is-invalid @enderror" min="0" step="1">
                        ...
                        <div class="helper-text">
                            Change stock quantity (auto adjust in stock history)
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="purchase_price"
                            value="{{ old('purchase_price', $catalog->purchase_price) }}" placeholder="Enter purchase price"
                            class="form-control-custom @error('purchase_price') is-invalid @enderror" min="0" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="retailer_price"
                            value="{{ old('retailer_price', $catalog->retailer_price) }}" placeholder="Enter selling price"
                            class="form-control-custom @error('retailer_price') is-invalid @enderror" min="0" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="base_price"
                            value="{{ old('base_price', $catalog->base_price) }}" placeholder="Enter base price"
                            class="form-control-custom @error('base_price') is-invalid @enderror" min="0">
                        @error('base_price')
                            <div class="invalid-feedback-custom">
                                <i class="fa fa-exclamation-circle"></i> {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="retailer_mrp"
                            value="{{ old('retailer_mrp', $catalog->retailer_mrp) }}" placeholder="Enter MRP"
                            class="form-control-custom @error('retailer_mrp') is-invalid @enderror" min="0">
                        @error('retailer_mrp')
                            <div class="invalid-feedback-custom">
                                <i class="fa fa-exclamation-circle"></i> {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="gst_percent"
                            value="{{ old('gst_percent', $catalog->gst_percent) }}" placeholder="Enter GST %"
                            class="form-control-custom @error('gst_percent') is-invalid @enderror" min="0" max="28">
                        @error('gst_percent')
                            <div class="invalid-feedback-custom">
                                <i class="fa fa-exclamation-circle"></i> {{ $message }}
                            </div>
                ...
                <div class="price-preview" id="previewSection">
                    <div class="price-preview-grid">
                        ...
                        <div class="price-preview-item">
                            <span class="price-preview-label">Profit Margin</span>
