                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <span class="badge bg-success bg-opacity-25 text-success">
                                        <i class="fas fa-arrow-up me-1"></i>{{ $todaySalesTrend ?? '+8.2%' }}
                                    </span>
                                </div>
                                <h6 class="text-muted fw-normal mb-2">Today's Sales</h6>
                                <h3 class="fw-bold text-success mb-0">₹ {{ number_format($todaySales ?? 0, 2) }}</h3>
                                <small class="text-muted">vs yesterday <span class="text-success">{{ $todayComparison ?? '+12%' }}</span></small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card dashboard-card monthly-sales h-100">
                            <div class="card-body">
                                ...
                                <h6 class="text-muted fw-normal mb-2">Monthly Sales</h6>
                                <h3 class="fw-bold text-primary mb-0">₹ {{ number_format($monthlySales ?? 0, 2) }}</h3>
                                @if(isset($monthlyTarget))
                                <small class="text-muted">Target: ₹ {{ number_format($monthlyTarget, 2) }}</small>
                                <div class="progress mt-2" style="height: 5px;">
                                    <div class="progress-bar bg-primary" style="width: {{ min(($monthlySales / $monthlyTarget) * 100, 100) }}%"></div>
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="card dashboard-card today-purchase h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <span class="badge bg-warning bg-opacity-25 text-warning">Today</span>
                                </div>
                                <h6 class="text-muted fw-normal mb-2">Today's Purchase</h6>
                                <h3 class="fw-bold text-warning mb-0">₹ {{ number_format($todayPurchase ?? 0, 2) }}</h3>
                                <small class="text-muted">{{ $purchaseTransactions ?? '0' }} transactions</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card dashboard-card net-profit h-100">
                            <div class="card-body">
                                ...
                                <h6 class="text-muted fw-normal mb-2">Net Profit/Loss</h6>
                                <h3 class="fw-bold {{ $profitClass }} mb-0">₹ {{ number_format($netProfit, 2) }}</h3>
                                <small class="text-muted">Today's margin</small>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <div class="d-flex justify-content-between mb-1">
                                        ...
                                        <small class="text-danger">{{ $overdueCustomers ?? '5' }} customers</small>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card dashboard-card h-100 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                @if(Route::has('stock.alerts'))
                                <a href="{{ route('stock.alerts') }}" class="btn btn-sm btn-outline-warning w-100 mt-3">
                        ...
                        <div class="card dashboard-card h-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span class="fw-bold">{{ $totalSuppliers ?? '25' }}</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <span><i class="fas fa-prescription-bottle text-info me-2"></i>Categories</span>
                                    <span class="fw-bold">{{ $totalCategories ?? '12' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card dashboard-card">
                            ...
                            <div class="card-body p-0">
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        <div>
                                            <small class="text-muted d-block">{{ $transaction->time ?? '10:30 AM' }}</small>
                                            <span>{{ $transaction->customer ?? 'Walk-in Customer' }}</span>
                                        </div>
                                        <div class="text-end">
                                            <span class="fw-bold">₹ {{ number_format($transaction->amount ?? 0, 2) }}</span>
                                            <span class="badge bg-success bg-opacity-10 text-success d-block">Paid</span>
                                        </div>
                                    </div>
                                    @empty
                            ...
                            <div class="card-footer bg-transparent border-0">
                                <a href="{{ route('transactions.index') }}" class="btn btn-sm btn-outline-primary w-100">View All Transactions</a>
                            </div>
                            @endif
                        </div>
                    </div>
